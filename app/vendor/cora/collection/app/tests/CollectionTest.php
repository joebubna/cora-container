...
{   
     ...
     *
     *  Removed until models converted to stand alone component.
     *  @test
     */
    ...
    public function canSortCollection()
    {
        $collection = new \Cora\Collection([
            ...
            new \Classes\Event('Debit', '10/10/2003'),
            new \Classes\Event('Deposit', '02/14/2004'),
            new \Classes\Event('Debit', '02/14/1985'),
            new \Classes\Event('Debit', '02/14/1994'),
            new \Classes\Event('Deposit', '02/14/1974')
        ]);
