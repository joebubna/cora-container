 ...
 *  Cora/Container
 *
 *  NOTE: Has dependency on \Cora\AbstractFactory class.
 */
class Container extends Collection
{
  ...
  /**
   * Returns one of the Cora framework's Abstract factories for the resource given.
   * If no closure is given that explicitly defines how to create an object of the desired type,
   * then the Container will be searched for a definition.
   * 
   * @oaran String $class The name of a class for which a factory is needed.
   * @param \Closure $closure [optional] A closure defining how to create the desired object.
   * @return \Cora\AbstractFactory
   */
